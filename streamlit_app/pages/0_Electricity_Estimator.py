...
def record_user_input(feature: str = None, input_type: str = None):
    """
...
with tab_household:
    ...
    with col1:
        ...
        record_user_input('TOTROOMS', 'number_input')
        for feature in ['STORIES','YEARMADERANGE']:
            record_user_input(feature, 'selectbox')
        record_user_input('HEATHOME', 'toggle')

    with col2:
        record_user_input('SMARTMETER', 'toggle')
        for feature in ['NCOMBATH', 'NHAFBATH']:
            record_user_input(feature, 'number_input')
...
with tab_appliances:
    ...
    with col1:
        for feature in ['DESKTOP','NUMLAPTOP', 'MICRO']:
            record_user_input(feature, 'number_input')
        record_user_input('NUMPORTEL', 'selectbox')
        for feature in ['CWASHER','AIRCOND']:
            record_user_input(feature, 'toggle')
