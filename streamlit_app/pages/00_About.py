...
st.set_page_config(page_title='HOW DOES THE MODEL WORKS?'
                   , page_icon='💻')

# nicer header with html:
st.markdown("<h2 style='text-align: center; color: #CF5050;'> How does our model work? 💻</h2>", unsafe_allow_html=True)
